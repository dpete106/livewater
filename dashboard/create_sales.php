...
<table class="table table-responsive table-sm" border="0" width="100%" cellspacing="4 cellpadding="6">
	<thead>
	<tr>
...
while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC)) {
    ...
    <td align="center"><input type="text" name="sale_price[' . $row['sku'] . ']" class="form-control" /></td>
	<td align="center"><input type="text" name="start_date[' . $row['sku'] . ']" class="calendar form-control" /></td>
	<td align="center"><input type="text" name="end_date[' . $row['sku'] . ']"  class="calendar form-control" /></td>
  </tr>';
}
?>

	</tbody></table>
	<div class="field"><input type="submit" value="Add These Sales" class="btn btn-info" /></div>
	</fieldset>
</form>
</div></div>
